...
func runTestCases(t *runner.TestRunner) {
	...
	t.Run("testlib/json.cx test-json.cx", runner.CxSuccess, "ProgramError in json lib.")
	t.Run("testlib/args.cx test-args.cx", runner.CxSuccess, "ProgramError in args lib.")
